...
export const LogoGMail = ({ size = 16 }: { size?: number }) => {
  return (
...
export const LogoWhatsapp = ({ size = 16 }: { size?: number }) => {
  return (<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 256 258">
    <defs>
